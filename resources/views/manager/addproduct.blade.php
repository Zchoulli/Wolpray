...
/**
   ...
   * @description: add product form - manager view
   * @version:     1.0
   * @date         26/05/2020
   * @param        none
   * @return       none
...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Añadir producto') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ action('ManagerController@ConfirmAddProduct') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="category" class="form-control{{ $errors->has('category') ? ' is-invalid' : '' }}" name="category" value="{{ old('category') }}" required autofocus>
                                    <option selected value='Cocktail' >Cocktail</option>
                                    <option value='Liqueur'>Licor</option>
                                    <option value='Refreshing drink' >Bebida Refrescante</option>
