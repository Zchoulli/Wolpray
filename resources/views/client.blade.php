...
/**
   ...
   * @description: show the home page of client logged ... clubs .. gmaps ... contact form ... - client view
   * @version:     1.0
   * @date         26/05/2020
   * @param        none
   * @return       none
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 mb-4">
            <div class="card h-100">
                <a href="client/show/{{$club->id}}"><img class="card-img-top" src="{{$club->cover_url}}" alt="Card image cap" width="100" height="200"/></a>
                <div>
                    <br>
...
<section id="contact" class="container" style="background-color: lavender">
    ...
    <br>
        ...
        @endif
        <form action="{{action('ClientController@contact')}}" method="GET">
            @csrf
