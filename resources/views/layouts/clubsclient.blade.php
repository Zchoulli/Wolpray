<!--
/**
   * @name:        clubsclient layout
   * @author:      Zaid - Patrik - Henry
   * @description: Menu - Navbar of club of client logged - client view
   * @version:     1.0
   * @date         26/05/2020
   * @param        none
   * @return       none
        ...
        <div class="main_menu" id="mainNav">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="{{ url('/client') }}"><img src="/images/logos/wolpraylogo-navbar.png" alt=""></a>
                                ...
                                <li class="nav-item"><a class="nav-link" href="#mapa">LUGAR</a>
                                    <li class="nav-item submenu dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item"><a class="nav-link {{ Request::is('dropdown/listmybills') ? 'active' : null}}" href="{{ route('listmybills') }}">{{ __('Mis facturas') }}</a>
